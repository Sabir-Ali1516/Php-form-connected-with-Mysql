...
<form class="form" action="form.php" method="post">
    ...
    <button class="button-submit" name="submit">Sign In</button>
...
if($con-> connect_error){
    die("DB is not connected:".$con -> connect_error);
}
...
if (isset($_POST["submit"])) {
    ...
    $password = $_POST["password"];
     ...
     $sql = "INSERT INTO `students` (`ID`, `Email`, `password`) VALUES (NULL, '$email', '$password')";
